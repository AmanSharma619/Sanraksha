...
const Footer = () => {
  return (
    <div className="bg-clr5">
      <div className="container mx-auto px-8 py-6 relative border-t border-t-clr3">
        ...
        <div className="absolute right-8 top-1/2 transform -translate-y-1/2 text-clr4">
          <span className="text-md">extra button</span>
        </div>
      </div>
